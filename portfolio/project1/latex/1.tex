...
\emph{This question seems a little ambiguous, given the definition of stopwords
as in\cite[2.2.2/(p. 27)]{irbook}. We'll assume that the question asks for
those among the 20 most frequent words that are likely to be relevant to
searching for some download.}
