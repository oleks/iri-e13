...
% Use a dictionary, formulate in a way as a Danish-English dictionary would
% translate it.
...
\url{http://www.fdim.dk/statistik/teknik/browserbarometer}.}
...
not necessarily representative of the general populous\cite[\textsection
2.3.3]{hearst}.
...
A test user is asked to proceed with the following tasks on their own, with
only moderate guidance by the experimenter in times of despair. The tasks below
are therefore directed towards the test user. Note that language is also
carefully chosen to be European, i.e. British in nature, e.g. we use the term
``delivery'' rather than ``shipping''. This is due to minor linguistic
differences between e.g. \texttt{amazon.com} and \texttt{amazon.co.uk}. There
is however no justification that the English of a Danish Computer Science
student is either more British or American.

\fbox{\parbox{\textwidth}{

Imagine you are at a friend's house. While your friend is preparing the last of
your evening meal you get to use the laptop in the dining room. You have
already logged into \texttt{amazon.com} with the account you created a couple
weeks ago, and entered your Danish address. The experimenter is your friend,
and an experienced \texttt{amazon.com} user.

\medbreak

In case you need it, the test user password is: MyTh1sIsP3swrd.
...
\item The test users found the search term suggestions \cite[\textsection
1.5.4]{hearst} useful when using the web site. The suggestions didn't only
